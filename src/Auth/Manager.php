...
class Manager
{
    ...
    /**
     * @var \Igniter\User\Auth\Models\User The currently authenticated user.
     */
    protected $user;
     ...
     *
     * @return \Igniter\User\Auth\Models\User
     */
     ...
     * @param bool $login
     *
     * @return \Igniter\User\Auth\Models\User|bool
     * @throws \Exception
     */
    ...
    /**
     * @return null|\Igniter\User\Auth\Models\User
     */
     ...
     *
     * @param \Illuminate\Contracts\Auth\Authenticatable|\Igniter\User\Auth\Models\User $user
     * @return array
     */
