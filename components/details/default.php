    ...
    <div class="col-md-12">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="text"
                           ...
                           name="first_name"
                           placeholder="<?php echo lang('label_first_name'); ?>">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="text"
                           ...
                           name="last_name"
                           placeholder="<?php echo lang('label_last_name'); ?>">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="text"
                           id="telephone"
                           class="form-control"
                           value="<?php echo set_value('telephone', $telephone); ?>"
                           name="telephone"
                           placeholder="<?php echo lang('label_telephone'); ?>">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="text"
                           ...
                           name="email"
                           placeholder="<?php echo lang('label_email'); ?>"
                           disabled>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="text"
                           ...
                           value="<?php echo set_value('security_answer', $security_answer); ?>"
                           placeholder="<?php echo lang('label_s_answer'); ?>">
            ...
            <div class="col-xs-9 col-sm-10 col-md-10">
									<span class="button-checkbox">
										<button type="button"
                                                class="btn"
                                                data-color="info"
                                                tabindex="7">&nbsp;&nbsp;<?php echo lang('button_subscribe'); ?></button>
                                        <?php if ($newsletter === '1') { ?>
                                            <input type="checkbox"
                                                   name="newsletter"
                                                   id="newsletter"
                                                   class="hidden"
                                                   value="1" <?php echo set_checkbox('newsletter', '1', TRUE); ?>>
                                        <?php } else { ?>
                                            <input type="checkbox"
                                                   name="newsletter"
                                                   id="newsletter"
                                                   class="hidden"
                                                   value="1" <?php echo set_checkbox('newsletter', '1'); ?>>
                                        <?php } ?>
									</span>
        ...
        <div class="form-group">
            <input type="password"
                   ...
                   class="form-control"
                   value=""
                   placeholder="<?php echo lang('label_old_password'); ?>"/>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="password"
                           ...
                           value=""
                           name="new_password"
                           placeholder="<?php echo lang('label_password'); ?>">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <input type="password"
                           ...
                           value=""
                           placeholder="<?php echo lang('label_password_confirm'); ?>">
