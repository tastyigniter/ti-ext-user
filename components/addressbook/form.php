        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       value="<?php echo set_value('address[address_1]', $address['address_1']); ?>"/>
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       class="form-control"
                       value="<?php echo set_value('address[address_2]', $address['address_2']); ?>"/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               class="form-control"
                               value="<?php echo set_value('address[city]', $address['city']); ?>"
                               name="address[city]"
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               class="form-control"
                               value="<?php echo set_value('address[state]', $address['state']); ?>"
                               name="address[state]"
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="<?php echo set_value('address[postcode]', $address['postcode']); ?>"
        ...
        <div id="new-address" class="col-md-12">
            <div class="form-group">
                ...
                <input type="text"
                       name="address[address_1]"
                       class="form-control"
                       value="<?php echo set_value('address[address_1]'); ?>"/>
                <?php echo form_error('address[address_1]', '<span class="text-danger">', '</span>'); ?>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text"
                       name="address[address_2]"
                       class="form-control"
                       value="<?php echo set_value('address[address_2]'); ?>"/>
                <?php echo form_error('address[address_2]', '<span class="text-danger">', '</span>'); ?>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        <input type="text"
                               class="form-control"
                               value="<?php echo set_value('address[city]'); ?>"
                               name="address[city]"
                               placeholder="<?php echo lang('label_city'); ?>">
                        <?php echo form_error('address[city]', '<span class="text-danger">', '</span>'); ?>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        <input type="text"
                               class="form-control"
                               value="<?php echo set_value('address[state]'); ?>"
                               name="address[state]"
                               placeholder="<?php echo lang('label_state'); ?>">
                        <?php echo form_error('address[state]', '<span class="text-danger">', '</span>'); ?>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        <input type="text"
                               class="form-control"
                               name="address[postcode]"
                               value="<?php echo set_value('address[postcode]'); ?>"
                               placeholder="<?php echo lang('label_postcode'); ?>">
                        <?php echo form_error('address[postcode]', '<span class="text-danger">', '</span>'); ?>
                    </div>
                </div>
