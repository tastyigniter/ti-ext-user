...
>
    ...
    <div class="form-group">
        <label><?= lang('sampoyigi.account::default.account.label_address_2'); ?></label>
        <input
            type="text"
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
                <label><?= lang('sampoyigi.account::default.account.label_city'); ?></label>
                <input
                    type="text"
                    class="form-control"
                    name="address[city]"
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
                <label><?= lang('sampoyigi.account::default.account.label_state'); ?></label>
                <input
                    type="text"
                    class="form-control"
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
                <label><?= lang('sampoyigi.account::default.account.label_postcode'); ?></label>
                <input
                    type="text"
                    class="form-control"
    ...
    <div class="form-group">
        <label><?= lang('sampoyigi.account::default.account.label_country'); ?></label>
    ...
    <div class="buttons">
        ...
        ><?= lang('sampoyigi.account::default.account.button_back'); ?></a>
        <button
            type="submit"
            class="btn btn-primary btn-lg"
        ><?= lang('sampoyigi.account::default.account.button_update'); ?></button>
    </div>
</form>
