<div class="table-responsive">
    <table class="table table-borderless">
        <tr>
            <td style="width:20%;"><b><?= lang('igniter.user::default.orders.column_id'); ?>:</b></td>
            <td><?= $customerOrder->order_id; ?></td>
        </tr>
        <tr>
            <td><b><?= lang('igniter.user::default.orders.column_date'); ?>:</b></td>
            <td><?= day_elapsed($customerOrder->order_date).' - '.$customerOrder->order_time; ?></td>
        </tr>
        <tr>
            <td><b><?= lang('igniter.user::default.orders.column_date_added'); ?>:</b></td>
            <td><?= day_elapsed($customerOrder->date_added); ?></td>
        </tr>
        <tr>
            <td><b><?= lang('igniter.user::default.orders.column_order'); ?>:</b></td>
            <td><?= $customerOrder->order_type_name; ?></td>
        </tr>
        <?php if ($customerOrder->isDeliveryType()) { ?>
            <tr>
                <td><b><?= lang('igniter.user::default.orders.column_delivery'); ?>:</b></td>
                <td><?= format_address($customerOrder->address); ?></td>
            </tr>
        <?php } ?>
        <tr>
            <td><b><?= lang('igniter.user::default.orders.column_payment'); ?>:</b></td>
        ...
        <tr>
            <td><b><?= lang('igniter.user::default.orders.column_location'); ?>:</b></td>
            <td>
...
<div class="text-center">
    <h4><?= lang('igniter.user::default.orders.text_order_menus'); ?></h4>
</div>
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            <th style="width:7%"></th>
            <th class="text-left"
                width="65%"><?= lang('igniter.user::default.orders.column_menu_name'); ?></th>
            <th class="text-right"><?= lang('igniter.user::default.orders.column_menu_price'); ?></th>
            <th class="text-right"><?= lang('igniter.user::default.orders.column_menu_subtotal'); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
...
<div class="buttons p-3">
    ...
    >
        ...
        <?= lang('igniter.user::default.orders.button_reorder'); ?>
    </a>
    <?php if ($showReviews) { ?>
        <td>
            <a
            ...
            >
                ...
                <?= lang('igniter.user::default.orders.text_leave_review'); ?>
            </a>
        </td>
    <?php } ?>
</div>
