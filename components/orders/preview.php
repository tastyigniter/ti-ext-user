<div class="table-responsive">
    <table class="table table-none">
        ...
        <tr>
            <td><b><?= lang('sampoyigi.account::default.orders.column_order'); ?>:</b></td>
            <td><?= $customerOrder->order_type_name; ?></td>
        </tr>
        <?php if ($customerOrder->isDeliveryType()) { ?>
            <tr>
                <td><b><?= lang('sampoyigi.account::default.orders.column_delivery'); ?>:</b></td>
                <td><?= format_address($customerOrder->address); ?></td>
            </tr>
        <?php } ?>
        <tr>
            <td><b><?= lang('sampoyigi.account::default.orders.column_payment'); ?>:</b></td>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            <th style="width:7%"></th>
            <th class="text-left"
                width="65%"><?= lang('sampoyigi.account::default.orders.column_menu_name'); ?></th>
            <th class="text-right"><?= lang('sampoyigi.account::default.orders.column_menu_price'); ?></th>
            <th class="text-right"><?= lang('sampoyigi.account::default.orders.column_menu_subtotal'); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
...
<div class="buttons">
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.orders.button_reorder'); ?>
    </a>
    <?php if ($showReviews) { ?>
        <td>
            <a
            ...
            >
                ...
                <?= lang('sampoyigi.account::default.orders.text_leave_review'); ?>
            </a>
        </td>
    <?php } ?>
</div>
