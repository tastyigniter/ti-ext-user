<div class="nav flex-column">
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.text_account'); ?>
    </a>
    <a
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.text_edit_details'); ?>
    </a>
    <a
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.text_address'); ?>
    </a>
    <a
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.text_orders'); ?>
    </a>
    ...
    >
        ...
        <?= lang('sampoyigi.account::default.text_reservations'); ?>
    </a>
    ...
    ><span class="fa fa-ban"></span>&nbsp;&nbsp;&nbsp;<?= lang('sampoyigi.account::default.text_logout'); ?>
    </a>
</div>
